    ...
    <div className="container mx-auto px-4 py-16 max-w-md">
      <Card className="p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          You now have full access to all features for the next 14 days. Explore
          everything our platform has to offer with no commitments.
        </p>
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Remember, you won&apos;t be charged during your trial period. You can
