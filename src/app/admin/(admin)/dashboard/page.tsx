...
import { 
  Users, Package2, Building2, Clipboard, ShieldCheck, 
  ArrowUp, ArrowDown, Clock, Bell 
} from "lucide-react";
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button variant="ghost" size="sm" className="gap-1" onClick={() => router.push('/admin/activity-log')}>
              <span>View all</span>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-3 rounded-lg border bg-background">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">The system has been updated to version 2.3.0</p>
              ...
              <div className="flex items-start gap-4 p-3 rounded-lg border bg-background">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">There has been an increase in new account creations</p>
                  <p className="text-xs text-muted-foreground/80 mt-1">Yesterday</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-3 rounded-lg border bg-background">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Current usage is at 68% of allocated resources</p>
                  <p className="text-xs text-muted-foreground/80 mt-1">3 days ago</p>
                </div>
              </div>
            </div>
          </CardContent>
