          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-6 max-w-2xl mx-auto text-xl text-muted-foreground">
                Get in touch with our team for any questions about GPSR
                compliance or our services
              </p>
            </div>
          </div>
        </section>
                ...
                <div className="sticky top-24">
                  ...
                  <div className="mt-12">
                    ...
                    <p className="text-muted-foreground mb-4">
                      DorukWell EU Authorized Representative
                      <br />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
              <Card className="p-6">
                ...
                <p className="text-muted-foreground mb-3">
                  The General Product Safety Regulation is an EU regulation
                  ensuring consumer products sold in the EU market are safe.
                </p>
                <Link
                  href="/faq"
              ...
              <Card className="p-6">
                ...
                <p className="text-muted-foreground mb-3">
                  If you&apos;re a non-EU manufacturer or seller marketing
                  products in the EU, you need an Authorized Representative.
                </p>
                <Link
                  href="/faq"
                  className="text-primary hover:underline text-sm font-medium"
              ...
              <Card className="p-6">
                ...
                <p className="text-muted-foreground mb-3">
                  ...
                  starting from €349/year for one product type.
                </p>
                <Link
                  href="/pricing"
                  className="text-primary hover:underline text-sm font-medium"
