...
import { ArrowLeft, Loader2, Upload, FileText, CheckCircle2, AlertTriangle, File } from "lucide-react";
...
export default function UploadDocuments() {
  ...
  const renderFileItem = (documentType, title, description) => {
        ...
        <div className="p-4">
          ...
          {file ? (
            ...
            <div className="relative border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center hover:bg-muted/50 transition-colors cursor-pointer">
              ...
              <p className="text-xs text-muted-foreground mt-1">PDF, Word, or image files up to 10MB</p>
            </div>
          )}
        </div>
      </div>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-8 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            <Link href="/add-product" className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold">Upload Product Documentation</h1>
              <p className="text-muted-foreground">Upload your product documentation for GPSR compliance</p>
            </div>
          </div>
          ...
          <Card className="border shadow-sm mb-8">
            <form onSubmit={handleSubmit}>
              <CardHeader>
                ...
                <CardDescription>Upload the necessary documentation for your product</CardDescription>
              </CardHeader>
          ...
          <div className="flex items-start p-4 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 dark:bg-amber-950 dark:border-amber-800 dark:text-amber-200">
            ...
            <div>
              <h3 className="font-medium">Important note about documentation</h3>
              <p className="text-sm mt-1">
                Under the General Product Safety Regulation (GPSR), product documentation must be maintained for a period of 10 years. These documents will be kept securely in our system and may be required by market surveillance authorities.
              </p>
            </div>
          </div>
        </div>
