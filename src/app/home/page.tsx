            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              <Card className="border shadow-sm hover:shadow-md transition-shadow relative flex flex-col">
                ...
                <CardContent className="flex-grow">
                  ...
                  <div className="text-sm text-muted-foreground mb-6">or €499 billed annually</div>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-2" />
                      <span>Full EU Authorized Representation</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-2" />
              ...
              <Card className="border-2 border-primary/30 shadow-md hover:shadow-lg transition-shadow relative flex flex-col">
                ...
                <CardContent className="flex-grow">
                  <div className="text-3xl font-bold mb-4">€99<span className="text-lg text-muted-foreground ml-1">/month</span></div>
                  <div className="text-sm text-muted-foreground mb-6">or €999 billed annually</div>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-2" />
                    ...
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-2" />
                      <span>20GB document storage</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-2" />
              ...
              <Card className="border shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <CardContent className="flex-grow">
                  <div className="text-3xl font-bold mb-4">€199<span className="text-lg text-muted-foreground ml-1">/month</span></div>
                  <div className="text-sm text-muted-foreground mb-6">or €1,990 billed annually</div>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-2" />
