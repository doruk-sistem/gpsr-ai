...
import { useGetUserProfileById } from "@/hooks/use-users";
...
export function ManufacturerModal({
  ...
  const { data: manufacturer, isLoading } =
    useAdminManufacturer(manufacturerId);
  const { data: user, isLoading: isUserLoading } = useGetUserProfileById(
                    ...
                    <div className="md:col-span-2 space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="font-medium">
                            {manufacturer?.authorised_signatory_name}
                          </p>
                        </div>
