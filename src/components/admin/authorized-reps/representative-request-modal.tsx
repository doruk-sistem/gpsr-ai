...
export function RepresentativeRequestModal({
  ...
  const { data: request, isLoading, updateNotes } = useAdminRepresentativeRequest(requestId);
  ...
  const saveNotes = async () => {
    ...
    try {
      ...
      await updateNotes({ id: requestId, notes: adminNotes });
                      ...
                      <div className="space-y-4 bg-muted/50 rounded-lg p-4 border">
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{request?.company_number}</p>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {request?.street_address}, {request?.city}, {request?.postal_code}, {request?.country}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="font-medium capitalize">{request?.business_role}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4 bg-muted/50 rounded-lg p-4 border">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{request?.contact_position}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4 bg-muted/50 rounded-lg p-4 border">
                      ...
                      <div>
                        ...
                        <p className="whitespace-pre-wrap">{request?.product_information}</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <Accordion type="multiple" className="w-full">
                        <AccordionItem value="ce-marking">
                          ...
                          <AccordionContent>
                            <p className="font-medium">{request?.ce_ukca_marking}</p>
                          </AccordionContent>
                        </AccordionItem>
                        
                        <AccordionItem value="technical-file">
                          <AccordionTrigger>Technical File Status</AccordionTrigger>
                          <AccordionContent>
                            <p className="font-medium">{request?.technical_file_ready}</p>
                          </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value="required-tests">
                          ...
                          <AccordionContent>
                            <p className="font-medium">{request?.required_tests_conducted}</p>
                          </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value="test-reports">
                          ...
                          <AccordionContent>
                            <p className="font-medium">{request?.test_reports_available}</p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start">
                        <div className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full ${request?.confirm_accuracy ? 'bg-green-100' : 'bg-red-100'} mr-2`}>
                      ...
                      <div className="flex items-start">
                        <div className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full ${request?.confirm_responsibility ? 'bg-green-100' : 'bg-red-100'} mr-2`}>
                        ...
                        <p className="text-sm">
                          Understands that Dorukwell does not verify technical files, and compliance remains the manufacturer's responsibility
                        </p>
                      </div>
                      
                      <div className="flex items-start">
                        <div className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full ${request?.confirm_terms ? 'bg-green-100' : 'bg-red-100'} mr-2`}>
                        ...
                        <p className="text-sm">
                          Agrees to Dorukwell's Authorised Representative service terms
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="bg-muted/50 rounded-lg p-4 border">
                    ...
                    {request?.test_reports_file_url ? (
                      ...
                      <p className="text-muted-foreground text-sm">No test report file available</p>
                    )}
                  </div>
                  
                  <div className="bg-amber-50/50 rounded-lg p-4 border border-amber-200">
                    <h3 className="font-medium mb-2 text-amber-800">Additional Documents</h3>
                    <p className="text-amber-700 text-sm">
                      The customer has not uploaded any additional documents yet. They will be prompted to upload required documentation after their request is approved.
                    </p>
                  </div>
                </div>
              )}
            ...
            <TabsContent value="notes" className="mt-6">
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Add private notes about this representative request. These notes are only visible to administrators.
                </p>
